...
*/
const uploadImageOne=function (successCallback, errorCallback) {
  
  var count = 1, uploadUrl = getApp().globalData.url+'mini/public_api/upload', inputName = 'pics';
  wx.chooseImage({
    count: 1,  //最多可以选择的图片总数  
