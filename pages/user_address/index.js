...
Page({
  ...
  */
  ...
  getUserAddress:function(){
    ...
    var that=this;
	requestApi('mini/user.address/get_user_address', 'GET', {  addressId:this.data.id}).then((res) => {
  ...
  */
  formSubmit:function(e){
	...
	requestApi('mini/user.address/edit_user_address', 'POST', { value:JSON.stringify(value)}).then((res) => {
