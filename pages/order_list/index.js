...
Page({
  ...
  */
  cancelOrder:function(e){
    ...
    requestApi('mini/order/cancel_order', 'GET', {order_id: order_id}).then((res) => {
		return app.Tips({title:res.data.msg,icon:'success'},function(){
  ...
  */
  getOrderList:function(){
	...
	requestApi('mini/order/order_status', 'GET', { 
