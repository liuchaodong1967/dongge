...
Page({
  ...
  getCombinationList:function(){
	...
	requestApi('mini/combination.Spell/pink_list', 'GET', {offset: that.data.offset, limit: that.data.limit}).then((res) => {
		console.log(res)
		...
		that.setData({
			...
			combinationList: combinationList.concat(res.data.data),
