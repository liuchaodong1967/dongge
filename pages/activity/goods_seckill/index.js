...
Page({
  ...
  getSeckillConfig: function () {
    var that = this; 
	requestApi('mini/seckill.index/seckill_config', 'GET', { }).then((res) => {
		console.log( res.data.data.lovely);
		that.setData({ topImage: res.data.data.lovely, timeList: res.data.data.seckillTime, active: res.data.data.seckillTimeIndex });
  ...
  getSeckillList: function () {
    var that = this; 
	requestApi('mini/seckill.index/seckill_list', 'GET', { offset: that.data.offset, limit: that.data.limit,time: that.data.timeList[that.data.active].id}).then((res) => {
			 var seckillList = that.data.seckillList;
			  var limit = that.data.limit;
			  var offset = that.data.offset;
			   that.setData({ 
				seckillList: seckillList.concat(res.data.data), 
